/**
 * Seed definitions for the marketplace taxonomy. Categories live in their own
 * MongoDB collection (models/Category.js) so new ones can be added at runtime
 * by an admin; this list is only the initial catalogue.
 */
const img = (slug) => `https://picsum.photos/seed/ac-cat-${slug}/900/700`;
