...
/*
 * A real 4:3 photograph when `npm run seed:photos` has produced one, otherwise
 * the illustration generated by scripts/generate-seed-art.mjs. Both are served
 * from the client, so neither needs a host.
 */
